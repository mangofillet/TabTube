...
export default defineComponent({
  ...
  computed: {
    ...
    // TabTube: the plain YouTube URL, shown above the player for easy copy/paste.
    youtubeUrl: function () {
  ...
  methods: {
    // TabTube: copy the plain YouTube URL to the clipboard.
    copyYoutubeUrl: function () {
      copyToClipboard(this.youtubeUrl)
