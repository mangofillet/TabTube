...
export default {
  // TabTube: distinct app ID so it never collides with FreeTube's install/update path.
  appId: 'io.github.mangofillet.TabTube',
  copyright: 'TabTube is an unofficial fork of FreeTube (AGPL-3.0). Copyleft © FreeTube contributors.',
  // asar: false,
  // compression: 'store',
